...
import com.Exception.Taxinotavailable;
...
public class TaxiBookingSystem {
    ...
    public static void bookTaxi() throws Taxinotavailable {
        ...
        if (selectedTaxi == null) {
            throw new Taxinotavailable(
                    "no taxis available at this time...sorry for inconvinence..plese try after some time ");
        }
