...
public class Taxi_Application {
    ...
    public static void bookTaxi() throws NoTaxiAvailable {
        ...
        if (selectedTaxi == null)
            throw new NoTaxiAvailable(
                    "Taxis are not available at this time....sorry for inconvinence...plese try after some time.");
